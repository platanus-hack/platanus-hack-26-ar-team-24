...
const EMOTIONAL_QUESTIONS = [
  ...
  {
    key: 'processing',
    label: 'Cuando algo te afecta, ¿cómo lo procesás?',
    left: 'Necesito pensarlo un rato',
    right: 'Lo suelto rápido y sigo',
  },
  {
    key: 'stress',
    label: 'Cuando hay mucha presión...',
    left: 'Me cuesta arrancar',
    right: 'Me da energía',
  },
  {
    key: 'impulsiveness',
    label: 'Antes de tomar una decisión...',
    left: 'La pienso bastante',
    right: 'Decido al toque',
  },
  {
    key: 'pragmatism',
...
const LIFESTYLE_QUESTIONS = [
  {
    key: 'order',
    label: 'Tu forma de trabajar es más...',
    left: 'Ordenada y planificada',
    right: 'Libre y desordenada',
  },
  {
    key: 'socialization',
    label: '¿Cómo te rinde más el día?',
    left: 'Trabajando solo y tranquilo',
    right: 'Rodeado de gente y charlas',
  },
  {
    key: 'learningPace',
    label: '¿Cómo aprendés mejor cosas nuevas?',
    left: 'Paso a paso, con calma',
    right: 'Mucha info junta y rápido',
  },
  {
    key: 'techSpillover',
    label: 'Cuando terminás de trabajar...',
    left: 'Desconecto del todo',
    right: 'Sigo metido en tech',
  },
] as const
