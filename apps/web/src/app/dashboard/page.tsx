  ...
  return (
    <div className="min-h-screen bg-ink-950 text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        <div className="mb-12">
          <p className="text-xs font-mono text-zinc-500 mb-3 tracking-wider uppercase">Personality Base</p>
        ...
        <div className="grid grid-cols-12 gap-4 auto-rows-[140px]">
          ...
          <BentoCard className="col-span-12 sm:col-span-8" icon={<Code size={14} />} label="Stack dominante">
            <div className="flex flex-wrap gap-2">
              {['TypeScript', 'Python', 'React', 'Postgres', 'AI/ML'].map(s => (
          ...
          <BentoCard className="col-span-6 sm:col-span-4" icon={<Zap size={14} />} label="Compatibilidad media">
            <p className="font-serif text-3xl text-white">87<span className="text-zinc-500 text-xl">%</span></p>
